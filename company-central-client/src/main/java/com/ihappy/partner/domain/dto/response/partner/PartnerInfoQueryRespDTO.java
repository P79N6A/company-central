 ...
 */
public class PartnerInfoQueryRespDTO extends ICallResponseBaseDTO {
    private static final long serialVersionUID = 5156590873994934127L;
    ...
    @FieldComment(value = "是否默认 1-默认，0-不是默认",required = false,defaultValue = "0")
    private Integer isDefault;

    @FieldComment(value = "是否删除 0-未删除 1-已删除")
    private Integer isDeleted;

    @FieldComment(value = "性别 0 保密 1 男 2女")
    private Integer sex;
    @FieldComment(value = "生日")
    private String birthday;
    @FieldComment(value = "微信昵称")
    private String wechatNickname;
    @FieldComment(value = "禁用  0：未禁用  1：禁用")
    private Integer forbidden;


    public void removeDebtAndPrepaidDeposit(){
        this.partnerArrears = null;
        this.partnerArrearsY = null;
        this.prepaidDeposit = null;
        this.prepaidDepositY = null;
    }
