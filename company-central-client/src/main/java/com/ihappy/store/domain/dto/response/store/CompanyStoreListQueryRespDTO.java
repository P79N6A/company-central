 ...
 */
public class CompanyStoreListQueryRespDTO extends ICallResponseBaseDTO {
    private static final long serialVersionUID = -7493001207208478463L;

    @FieldComment(value = "门店过期  true：过期 false：未过期",required = false,defaultValue = "")
    ...
    @FieldComment(value = "支付宝账号二维码")
    private String alipayAccountQrcode;

    @FieldComment(value = "支付宝账号二维码内容")
    private String alipayAccountQrcodeContent;

    @FieldComment(value = "支付宝收款码图片")
