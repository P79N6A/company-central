 ...
 * @author : zhangtengpo
 * @Description :
 * @create : 2018-06-11 14:57
 */
public class QueryWeshopDetailProcess extends DefaultQueryProcess<WeshopDetailQueryReqDTO,WeshopDetailQueryRespDTO> {
    ...
    public void process(Context<WeshopDetailQueryReqDTO, WeshopDetailQueryRespDTO> context) {
        ...
        BaseinfoCompanyStore store = baseinfoCompanyStores.get(0);
